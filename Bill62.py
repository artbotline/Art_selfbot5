...
#kk = LINETCR.LINE()
#kk.login(qr=True)
#kk.login(token='ErJ6EcYLxLXvpFjecKv3.79PAR+RAKsSM2zgsVO+CyW.L9I1tyNHPJogW92d4PJvv97vlsJi4nHuRSoCDi3fm38=')
#kk.loginResult()
#print "Kk-Login Success\n"

#kc = LINETCR.LINE()
#kc.login(qr=True)
#kc.login(token='Er8E3Vp4BIaxSjIzX371.AD3P2UMLgZuyeauB9gdXaq.v7Z/dF1ncLQniQRZew+NrQsS/7Ascvz1rmbTOja09QI=')
#kc.loginResult()
#print "Kc-Login Success\n"

#kr = LINETCR.LINE()
#kr.login(qr=True)
#kr.login(token='ErebkebpY3wbGc3WL0Oa.Xfl9nQtDPVEo54Iq5GTYwG.xby2aQJnOon75gN5/Prr4cpFoA5XC/prmpnzYvWX/mg=')
#kr.loginResult()
